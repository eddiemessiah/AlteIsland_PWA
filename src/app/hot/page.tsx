      ...
      <main className="pt-24 px-6 max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
        ...
        <div className="lg:col-span-5 space-y-8 stagger-slide">
          <div className="glass-panel rounded-3xl p-6 md:p-8 glass-grain border border-white/5 shadow-2xl lg:sticky lg:top-28 voting-card">
            <div className="flex items-center justify-between mb-8">
              <h2 className="font-['Inter'] font-bold text-xl md:text-2xl text-[#ff89ab]">Vetting Now</h2>
            ...
            <div className="relative aspect-square rounded-2xl overflow-hidden mb-8 group">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <h3 className="font-['Inter'] text-2xl md:text-3xl font-bold mb-1">Indigo Sky Lounge</h3>
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="flex items-center justify-between mb-4 md:mb-6 px-2 stagger-slide">
            <h2 className="font-['Inter'] font-extrabold text-2xl md:text-3xl tracking-tight">
          ...
          <div className="space-y-3">
            {leaderboard.map((item, index) => (
              <div key={index} className="group glass-panel rounded-2xl p-3 md:p-4 flex items-center gap-4 hover:bg-[#272528]/80 transition-all duration-300 stagger-slide cursor-pointer border border-transparent hover:border-white/10">
                <div className="w-8 h-8 md:w-12 md:h-12 flex items-center justify-center font-['Inter'] font-black text-xl md:text-2xl text-[#00e3fd] opacity-40 group-hover:opacity-100 transition-opacity">
                  {item.rank}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="font-['Inter'] font-bold text-base md:text-xl mb-0.5 truncate">{item.name}</h4>
          ...
          <button className="w-full mt-6 py-4 rounded-xl border border-white/5 bg-[#141315] font-['Inter'] font-bold text-[#aeaaad] hover:text-white hover:bg-[#272528] transition-colors stagger-slide text-sm">
